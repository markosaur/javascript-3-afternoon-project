...
function showValues(obj) {
  let stir = ""           //you need to set up an empty string to throw the concatenated values into
  for(let key in obj){    // this will go through the object property by property and grab the key.  the key is the value that we actually want, the prperty 
    stir += obj[key]      //the += will continually add the keys to the string
  }
  return stir 
}
